...
#define DEFINE_OPCODE_HANDLER(opcode, status, processing, handler)                              \
    ...
    DEFINE_OPCODE_HANDLER( CMSG_VERIFY_CONNECTIVITY_RESPONCE,            STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_EarlyProccess            );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_TIME_SYNC_RESP,                          STATUS_AUTHED,   PROCESS_THREADUNSAFE,  &WorldSession::HandleTimeSyncResp              );
    DEFINE_OPCODE_HANDLER( CMSG_ENABLE_NAGLE,                            STATUS_UNHANDLED,PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_VIOLENCE_LEVEL,                          STATUS_AUTHED,   PROCESS_THREADUNSAFE,  &WorldSession::HandleViolenceLevelOpcode       );
    ...
    DEFINE_OPCODE_HANDLER( MSG_CHANNEL_UPDATE,                           STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMoveTeleportAck           );
    DEFINE_OPCODE_HANDLER( MSG_CHANNEL_START,                            STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMoveTeleportAck           );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_ITEM_QUERY_MULTIPLE,                     STATUS_UNHANDLED,PROCESS_THREADUNSAFE,  &WorldSession::Handle_NULL                     );
    DEFINE_OPCODE_HANDLER( CMSG_REQUEST_CEMETERY_LIST,                   STATUS_UNHANDLED,PROCESS_THREADUNSAFE,  &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_QUERY_GUILD_REWARDS,                     STATUS_UNHANDLED,PROCESS_THREADUNSAFE,  &WorldSession::Handle_NULL                     );
    DEFINE_OPCODE_HANDLER( CMSG_QUERY_GUILD_MAX_XP,                      STATUS_UNHANDLED,PROCESS_THREADUNSAFE,  &WorldSession::Handle_NULL                     );
    DEFINE_OPCODE_HANDLER( CMSG_QUERY_GUILD_XP,                          STATUS_UNHANDLED,PROCESS_THREADUNSAFE,  &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER( CMSG_NPC_TEXT_QUERY,                          STATUS_LOGGEDIN, PROCESS_THREADSAFE,    &WorldSession::HandleNpcTextQueryOpcode        );
    // Movement:
    ...
    //DEFINE_OPCODE_HANDLER( CMSG_GUILD_BANK_NOTE,                         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::Handle_NULL                     );
