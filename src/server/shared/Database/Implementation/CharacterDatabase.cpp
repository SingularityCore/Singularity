...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    "health, power1, power2, power3, power4, power5, power6, power7, power8, power9, power10, power11, instance_id, speccount, activespec, exploredZones, equipmentCache, knownTitles, achievementPoints, actionBars, grantableLevels FROM characters WHERE guid = ?", CONNECTION_ASYNC)
